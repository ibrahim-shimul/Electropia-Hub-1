          ...
          <div className="lg:col-span-4">
             <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 sticky top-24">
                ...
                <div className="space-y-3 text-sm mb-6">
                  <div className="flex justify-between text-slate-600">
                    <span>Sub Total</span>
                    <span className="font-medium text-slate-900">৳47,370</span>
                  </div>
                  <div className="flex justify-between text-slate-600">
                    <span>Shipping</span>
                  ...
                  {selectedPayment === 'emi' && (
                    <div className="flex justify-between text-slate-600">
                      <span>EMI Convenience Fee <br/><span className="text-[10px]">(The City Bank, 36M @16%)</span></span>
                      <span className="font-medium text-slate-900">৳7,484</span>
                    </div>
                  )}
                </div>

                <div className="flex justify-between items-end pt-4 border-t border-slate-200 mb-6">
                  <span className="font-bold text-slate-800">Grand total</span>
                  <span className="font-heading font-black text-2xl text-slate-900">৳54,254</span>
                </div>
